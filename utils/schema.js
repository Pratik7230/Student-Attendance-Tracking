...
import { boolean, int, mysqlTable, varchar, datetime, primaryKey } from "drizzle-orm/mysql-core";
...
export const teacherSubjectsRelations = relations(TEACHER_SUBJECTS, ({ one }) => ({
...
export const ATTENDANCE = mysqlTable('attendance', {
  ...
  studentId: int('studentId', { length: 11 }).notNull().references(() => STUDENTS.id),
...
export const USER = mysqlTable("user", {
  ...
  role_id: int("role_id", { length: 11 }).notNull().references(() => ROLE.id), // Foreign key reference to roles table
